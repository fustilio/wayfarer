...
const AnimatedSheetOverlay = Animated.createAnimatedComponent(
  SheetPrimitive.Overlay,
);

const AnimatedSheetContent = Animated.createAnimatedComponent(
...
>(({ className, children, ...props }, ref) => (
  <AnimatedSheetOverlay
    ...
    className={cn(
      "z-40 flex items-center justify-center bg-black/80",
      className,
    )}
    {...props}
    ref={ref}
  ...
  return (
    <SheetPortal>
      ...
      <AnimatedSheetContent
        ...
        {...props}
        entering={entering?.duration(enteringDuration)}
      >
        {children}
